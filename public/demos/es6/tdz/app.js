...
new Vue({
  ...
  methods: {
    ...
    testVarNoTDZ() {
      ...
      this.results.push(`声明前访问: <span class="success">${beforeValue}</span> (不报错，只是 undefined)`)
    ...
    testLetTDZ() {
      ...
      this.results.push('<span class="highlight">❌ ReferenceError: Cannot access \'name\' before initialization</span>')
      this.results.push('')
